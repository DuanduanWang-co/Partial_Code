...
function pacemaker_fhn!(du, u, h, p, t)
    ...
    kk1, kk2, kk3, kk4, c1, c2, c3, c4, d1_ode, d2_ode, d3_ode, d4_ode, h1, h2, h3, h4, g1, g2, g3, g4, w11, w12, w21, w22, w31, w32, w41, w42, a_K, a_Ca, K_0, K_1, Ca_0, Ca_1 = p[22:end]
    KATDe = 4e-5
    KATRe = 4e-5
    KVNDe = 9e-5
    KVNRe = 6e-5
    ...
    # T wave
    du[13] = kk4 * (-c4 * z4 * (z4 - w41 + a_K*(K_1-K_0))* (z4 - w42 + a_Ca*(Ca_1 - Ca_0)) - d4_ode * v4 * z4 + I_VN_Re)
    #Two options for T wave:
    #+a_K*(K_1 - K_0) + a_Ca*(Ca_1 - Ca_0), linear
    #+a_K * log(K_1/K_0), a_Ca * log(Ca_1/Ca_0), logarithmic
    #To be confirmed by fitting model
...
for a_Ca in a_Ca_values

p = [a1, a2, a3, u11, u12, u21, u22, u31, u32, f1, f2, f3, d1, d2, d3, e1, e2, e3, K_SA_AV, K_AV_HP, τ,
     kk1, kk2, kk3, kk4, c1, c2, c3, c4, d1_ode, d2_ode, d3_ode, d4_ode, h1, h2, h3, h4, g1, g2, g3, g4, w11, w12, w21, w22, w31, w32, w41, w42, a_K, a_Ca, K_0, K_1, Ca_0, Ca_1]
